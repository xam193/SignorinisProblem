...
\begin{definition}[Spaces of Continuously Differentiable Functions]
	We denote by $\cC^0(\Omega)$ the space of continuous functions $u:\Omega\to\R$ and define $\cC^0(\Omega;\R^m):= (\cC^0(\Omega;\R))^m$ as the space of continuous functions $F:\Omega\to\R^m$. The space of {\tt continuously differentiable} functions $F:\Omega\to\R^m$ up to order $0\le k<\infty$ then is
	\begin{equation*}
		\cC^k(\Omega;\R^m):=\left\{ F\in\cC^0(\Omega;\R^m)\;\middle|\; |\alpha|\le k\;\Rightarrow\;\Diff^\alpha (F)_j\in\cC^0(\Omega)\;\forall\,1\le j\le m\right\},
	\end{equation*}
	where $(F)_j:\Omega\to\R$ denotes the $j$-th component of $F:\Omega\to\R^m$. Furthermore,
	\begin{equation*}
		\cC^k(\Omega;\R^{m\times n}) := (\cC^k(\Omega;\R^m))^n,\qquad \forall\,0\le k<\infty.
	\end{equation*}
\end{definition}

\begin{definition}[Spaces of Infinitely Differentiable Functions]
...
\begin{definition}[Distributions]
	...
	\end{equation*}
	Analogously, the space $\cD^\prime(\Omega;\R^{m\times n})$ is defined componentwise, and for
	\begin{equation*}
